...
public abstract class Tasima {
    ...
    private void log() {
        System.out.println("Ara islem ya da sistem loglama kodları burada yazılabilir.");
    }

    /**
     * tüm sınıfların içini kendi yapısına göre doldurmasını istediğim kodları
     * burada sözleşme mantığı ile tanımlıyoruz.
     */
